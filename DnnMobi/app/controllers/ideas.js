var args = arguments[0] || {};
    ...
    var success = function(e) {		
			...
			for (var i = 0; i < response.Results.length; i++) {
				var idea = response.Results[i];		
				
			    data.push({
			        title : { text: idea.contentTitle },
			        when : { text: idea.lastActiveRelativeDate },
			        //message : { text: topic.contentSummary },
			        profilePic : { image: WebApiHelper.profilePic(idea.createdByUserId) },
			        properties : {
			            itemId: idea.ideaId,
	...
	function reload() {
		...
		var url = '/DesktopModules/DNNCorp/Ideas/API/List/Query';
		...
		$.activityIndicator.show();
		WebApiHelper.PostAsJson('Ideas', url, data, success, failure);
	}
